...
| [Gemini structured output](https://ai.google.dev/gemini-api/docs/generate-content/structured-output) | `gemini-3.6-flash` | Service documentation; no code copied | Schema-constrained mission proposal |
