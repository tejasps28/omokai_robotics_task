...
# This is an emergency stop, not a comfortable traffic-planning clearance.
# The scheduler handles normal shared-space coordination; only robots that are
# nearly touching should cancel the active squad mission.
EMERGENCY_MINIMUM_DISTANCE_M = 0.30
